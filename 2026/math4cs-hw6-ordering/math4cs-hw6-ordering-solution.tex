% math4cs-hw6-ordering-solution.tex
...
\begin{proof}
  ...
  \textbf{分值分配（10分）.}
  \begin{enumerate}[(1)]
    \item 正确证明 $\sim$ 是等价关系: \score{2}
    \item 正确证明商集上的 $\le$ 良定义并满足偏序三公理: \score{3}
    \item 正确分析 $(\Z, \mid)$ 的拟序性与等价类: \score{2}
    \item 正确描述 $\Z/\sim$ 上的偏序及其抽象含义: \score{1}
    \item 正确分析可达关系的拟序性、等价类与商偏序: \score{2}
  \end{enumerate}
\end{proof}
%%%%%%%%%%%%%%%
...
\begin{proof}
  ...
  \textbf{分值分配（10分）.}
  \begin{enumerate}[(1)]
    \item 明确将函数视为有序对集合: \score{1}
    \item 正确证明自反性: \score{3}
    \item 正确证明反对称性: \score{3}
    \item 正确证明传递性并得出偏序结论: \score{3}
  \end{enumerate}
\end{proof}
%%%%%%%%%%%%%%%
...
\begin{solution}
  ...
  \textbf{分值分配（10分）.}
  \begin{enumerate}[(1)]
    \item 正确给出 $\sup(S)$ 的表达式: \score{5}
    \item 正确给出 $\inf(S)$ 的表达式: \score{5}
  \end{enumerate}
\end{solution}
%%%%%%%%%%%%%%%
...
\begin{proof}
  ...
  \textbf{分值分配（10分）.}
  \begin{enumerate}[(1)]
    \item 正确定义生成上确界的关系 $\approx$: \score{2}
    \item 正确证明 $X/\approx$ 是上界: \score{2}
    \item 正确证明 $X/\approx$ 是最小上界: \score{2}
    \item 正确给出下确界的表达式: \score{2}
    \item 正确说明该表达式确为最大下界: \score{2}
  \end{enumerate}
\end{proof}
%%%%%%%%%%%%%%%
